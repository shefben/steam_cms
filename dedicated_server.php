...
<head>
	<title>Dedicated Server install files</title>
...
<!-- non-Steam distribution of Ded server update files -->
...
To save file size, we've created seperate downloads for each game. In this case, the Day of Defeat server update is larger than the others.<br><br>
<div style="background:#4C5844;padding:0.5em;font-weight:bold;">
