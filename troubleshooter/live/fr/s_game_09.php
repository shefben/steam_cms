...
<tr valign="top">
	...
	<h1>Je n'arrive pas à utiliser les modèles avec vue pour droitiers.</h1>
	<hr>
    
	<p>Assurez-vous que vous n'exécutez pas le logiciel en mode "Logiciel" (mode vidéo). Ce mode ne prend pas en charge les modèles avec vue pour droitiers.</p>

	<ul>
<li> <a href="s_game_09_f.php">Le problème n'a pas été résolu.</a>
