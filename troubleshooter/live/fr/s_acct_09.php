...
<tr valign="top">
	...
	<h1>Je souhaite vraiment supprimer mon compte.</h1>
	<hr>
    
	<p>Nous avons besoin d'un certain nombre d'informations pour traiter votre requête.</p>
...
<tr>
<td nowrap><p><strong>Votre mot de passe Steam :</strong>&nbsp;</p></td>
<td width="100%"><input type="text" name="f_9" class="form_100p"></td>
</tr>
 
<tr>
<td width="100%" colspan="2"><p><br><strong>Souhaitez-vous nous communiquer d'autres informations ?</strong>&nbsp;</p></td>
</tr>
<tr>
