function toggle_section( section )
{
	...
	if ( img_src.indexOf( 'http://www.steampowered.com/v/up.gif' ) != -1 )
	{
		document.getElementById( section_header ).src = 'img/icons/ico_arrow_dn.gif';
		document.getElementById( section_content ).style.display = 'none';
		createCookie( section_cookie, 'closed', 365 );
	}
	else
	{
		document.getElementById( section_header ).src = 'img/icons/ico_arrow_up.gif';
