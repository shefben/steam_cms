...
<ul><li><em>How do I stop Steam from running automatically when I start my computer?</em></li></ul>
<p><br>From the Steam icon in the notification tray, select Settings. Switch to the Interface tab, and uncheck the box that says "Run Steam when Windows starts".</p>
			<p style="font-size: 10px;">
			<i>modified on July 9, 2003, 6:24 pm</i><br>
			</p>
