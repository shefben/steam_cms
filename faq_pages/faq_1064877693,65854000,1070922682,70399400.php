...
<ul><li><em>Is it possible to pass login info to Steam from the command line?</em></li></ul>
<p><br>Yes. You can launch Steam using a "login" command line option. This is useful for many caf&eacute; system administrators. The syntax is as follows:<br><br><b>steam.exe -login [username] [password]</b><br><br>(Remember that Steam "usernames" are most often in the form of an email address.)<br>(Note also that it will take a few seconds for the program to launch using this method, and that you may not see anything happening during this time.)</p>
			<p style="font-size: 10px;">
			<i>modified on December 8, 2003, 2:32 pm</i><br>
			</p>
