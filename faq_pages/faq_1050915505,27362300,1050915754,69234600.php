...
<ul><li><em>I'm getting a "This game is currently unavailable" message. What gives?</em></li></ul>
<p><br>This error can happen when the Steam network is experiencing problems or downtime. Please see the <a href="status.html">Steam Network Status page</a>.</p>
			<p style="font-size: 10px;">
			<i>modified on September 29, 2003, 4:16 pm</i><br>
			</p>
