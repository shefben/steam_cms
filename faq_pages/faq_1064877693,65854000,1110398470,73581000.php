...
<ul><li><em>Where can I get my validation code if I haven't received it?</em></li></ul>
<p><br>To get validation code verified go to the "Settings" menu and click on "Verify email address".</p>
			<p style="font-size: 10px;">
			<i>modified on March 9, 2005, 12:01 pm</i><br>
			</p>
