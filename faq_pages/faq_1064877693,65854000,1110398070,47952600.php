...
<ul><li><em>When I try to download Steam and the games, it says the FTP file is corrupt.  What do I do?</em></li></ul>
<p><br>Install Steam from our <a href="/index.php?area=getsteamnow">web site</a> and set up one machine. Download all the game and copy the Steam Directory on all the other machines.</p>
			<p style="font-size: 10px;">
			<i>modified on March 9, 2005, 11:54 am</i><br>
			</p>
