...
<ul><li><em>Why am I having trouble connecting after a recent Steam update?</em></li></ul>
<p><br>Users with certain software firewall programs can sometimes experience problems after steam.exe is updated. If your software firewall is denying steam.exe access to the Internet after a Steam update, you may need to manually update your firewall settings to allow steam.exe the access that it needs.<br><br>It appears that some firewall programs will not prompt you when the file changes; instead, those programs just cut off Steam's access. So if you can't connect (or if you get no game servers listed in the server browser) you might want to re-check your firewall settings for Steam.exe.</p>
			<p style="font-size: 10px;">
			<i>modified on December 17, 2003, 1:25 pm</i><br>
			</p>
