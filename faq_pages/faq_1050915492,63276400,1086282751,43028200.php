...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>Can I distribute copies of any files in the Steam cache?</em></li></ul>
<p><br>No.<br><br>Re-distribution of files from your Steam cache is illegal and a violation of the <a href="/index.php?area=subscriber_agreement">Steam Subscriber Agreement</a>. As with other illegal activity, any Steam Subscribers participating in the distribution of files from their Steam cache or any other Valve content not permitted for re-distribution may have their accounts terminated. In accordance with the Steam Subscriber Agreement, Valve provides a limited license to re-distribute copies of the Steam Installer. For more information, please read the Steam Subscriber Agreement. The Steam Installer can be found at /index.php?area=getsteamnow.</p>
			<p style="font-size: 10px;">
			<i>modified on June 3, 2004, 10:12 am</i><br>
			</p>
