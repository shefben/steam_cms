...
<ul><li><em>How do I use custom content in Counter-Strike?</em></li></ul>
<p><br>You can drop in custom files, like the CS fusion pack, into your <em>Steam/SteamApps/your_email_address/Counter-Strike/</em> directory. Steam will use the customized files on disk instead of the ones in the Steam cache file. <br><br>For a more in-depth set of instructions specific to the Fusion Pack, see <a href="http://forums.games-fusion.net/index.php?showtopic=1211" target="_blank">this tutorial</a> posted on Fusion.net.</p>
			<p style="font-size: 10px;">
			<i>modified on June 16, 2004, 11:08 am</i><br>
			</p>
