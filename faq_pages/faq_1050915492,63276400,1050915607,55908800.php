...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>What are the system requirements for Steam?</em></li></ul>
<p><br>Windows 98, ME, 2000 or XP <br>64 MB RAM <br>400 Mhz processor <br>1GB HD space (strongly recommended) <br>Broadband Internet connection (recommended but not required) <br><br>It is also recommended that Steam be installed on a hard disk formatted using NTFS. Fat32 drives will work, but performance will be slower.</p>
			<p style="font-size: 10px;">
			<i>modified on September 29, 2003, 4:14 pm</i><br>
			</p>
