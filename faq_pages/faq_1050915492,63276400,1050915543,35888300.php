...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>What is Steam?</em></li></ul>
<p><br>Steam is Valve's new broadband platform for direct software delivery and content management.<br><br>Steam lets you:<br><ul><br><li>Buy Valve games via the Internet, and start playing within minutes of confirming your purchase</li><br><li>Access your games from any PC</li><br><li>Stop worrying about product updates and patches (they're all handled automatically!)</li><br><li>Instant-message your friends, even while playing games.</li><br><li>Browse and connect to game servers</li><br><li>See when your friends are playing, and join their games</li><br></ul><br>In addition to using Steam to deliver games, Valve is also making Steam available to other software developers. Steam is a distributed file system and shared set of technology components that can be implemented into any software application. With Steam, software developers are given integrated tools for direct-content publishing, flexible billing, ensured-version control, anti-cheating, anti-piracy, and more. The Steam SDK also includes an integrated set of communications tools and Valve&apos;s Graphic User Interface (V-GUI) that provide built-in support for a variety of services such as instant messaging, configuration, and server browsing.</p>
			<p style="font-size: 10px;">
			<i>modified on August 15, 2003, 2:38 pm</i><br>
			</p>
