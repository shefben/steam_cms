...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>What products are available through Steam?</em></li></ul>
<p><br>Currently Valve is offering its entire catalog of games via Steam. Also, Valve's games which are currently still in development will be released via Steam as soon as they are finished.</p>
			<p style="font-size: 10px;">
			<i>modified on July 9, 2003, 6:06 pm</i><br>
			</p>
