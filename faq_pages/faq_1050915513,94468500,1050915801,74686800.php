...
<ul><li><em>Can I be a Steam content provider?</em></li></ul>
<p><br>Yes. We've signed up several partners to be Steam content providers, and we're always looking for more. To get started, we require that you have one or more available servers running Windows 2000 Server Edition, and at least 50megabits/sec of bandwidth. Please send a note to <a href="mailto:biz@steampowered.com">biz@steampowered.com</a>, and we'll get back to you ASAP.</p>
			<p style="font-size: 10px;">
			<i>modified on July 11, 2003, 3:50 pm</i><br>
			</p>
