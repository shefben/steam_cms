...
<ul><li><em>What does it mean when I get a "Ticket expired" error in Steam?</em></li></ul>
<p><br>Usually, this just means you need to re-enter your login information so that Steam can authenticate you. You may need to exit Steam and restart it in order to do this.</p>
			<p style="font-size: 10px;">
			<i>modified on July 9, 2003, 6:45 pm</i><br>
			</p>
