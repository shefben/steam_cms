...
<ul><li><em>How long does it take to setup the CAS server?</em></li></ul>
<p><br>It takes approximately one hour to set up the CAS Server; five hours for it to retrieve all the updates; and 15 minutes for each client once the CAS Server has all the content.</p>
			<p style="font-size: 10px;">
			<i>modified on March 8, 2005, 3:44 pm</i><br>
			</p>
