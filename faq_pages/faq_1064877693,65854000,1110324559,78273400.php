...
<ul><li><em>How do I increase or decrease the number of licenses in my caf&eacute;?</em></li></ul>
<p><br>Please send an email to <a href="mailto:cybercafes@valvesoftware.com">cybercafes@valvesoftware.com</a> with the number of licenses you wish to add or subtract.  We will send you a confirmation email when your order has been processed.</p>
			<p style="font-size: 10px;">
			<i>modified on March 8, 2005, 3:34 pm</i><br>
			</p>
