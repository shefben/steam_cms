...
<ul><li><em>Do I have to use a different email address for each computer when I install Steam?</em></li></ul>
<p><br>For now, yes.<br><br>Steam requires a unique "email address" to be used for each licensed computer in your caf&eacute;. The email address in this case is really just a login name – it does not have to be an actual valid email address. We suggest that you use the name of the machine in your caf&eacute;, with a common domain name suffix. See <a href="/?area=cafe_setup">this instructions page</a> for information on how to get Steam up and running in your caf&eacute;.</p>
			<p style="font-size: 10px;">
			<i>modified on November 7, 2003, 3:54 pm</i><br>
			</p>
