...
<ul><li><em>Why is my Norton firewall reporting that Valve's trying to infect my computer with a "trojan horse"?</em></li></ul>
<p><br>This is a false positive from the Norton firewall product.<br><br>Occasionally the Friends server sends your computer a message asking if you're still online. If you closed Steam (especially if you kill it from task manager) this message can be intercepted by the Norton firewall. And since Friends sometimes uses the same port number as a known trojan, the firewall incorrectly identifies the message as being malicious -- even though it's not trojan traffic at all.</p>
			<p style="font-size: 10px;">
			<i>modified on February 19, 2004, 1:42 pm</i><br>
			</p>
