...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>Where can I get Steam?</em></li></ul>
<p><br>Right here: <a href="/index.php?area=getsteamnow"><img align="absmiddle" src="/img/but_getsteamnow.gif" height="24" width="124" alt="get steam now"></a><br><br>Also, Steam will soon be included in any new Valve products sold in retail stores.</p>
			<p style="font-size: 10px;">
			<i>modified on July 10, 2003, 5:15 pm</i><br>
			</p>
