...
<ul><li><em>I use a multi-computer administration program to configure and manage my computers & it doesn&apos;t seem to work with Steam. What do I do?</em></li></ul>
<p><br>We cannot guarantee that Steam will work with every administration software package, but we have heard reports from many of our caf&eacute; customers that Steam is compatible with their admin systems. We will do our best to provide you with enough information to get your caf&eacute; working with whatever admin program you use. Please <a href="mailto:cafe@valvesoftware.com">contact us</a> if you need assistance.</p>
			<p style="font-size: 10px;">
			<i>modified on November 7, 2003, 4:13 pm</i><br>
			</p>
