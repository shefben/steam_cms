...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>Will I still be able to buy Valve's games in stores?</em></li></ul>
<p><br>Yes, Valve's games will still be available for purchase in stores.<br><br>Some users will prefer to have a boxed copy of our games, or won't have access to a fast enough Internet connection to aquire game content (the games can be several hundred megabytes each).<br><br>Even though some users may choose not to <i>buy</i> games via Steam, Steam will still be useful as a way to chat with other players, find multiplayer game servers, and more.</p>
			<p style="font-size: 10px;">
			<i>modified on July 9, 2003, 8:29 pm</i><br>
			</p>
