...
<ul><li><em>I&apos;ve heard there&apos;s a special version of Steam for Caf&eacute; owners. What, exactly, is different about the "Caf&eacute; version" of Steam? How do I get it?</em></li></ul>
<p><br>There isn&apos;t really a different version of Steam for Caf&eacute;s. But when an official Caf&eacute; product key is used in Steam, a couple of special things happen:<br>- Your Steam account gives you access to all of the games currently on Steam<br>- Steam requires a password to be entered when the user tries to logout or quit</p>
			<p style="font-size: 10px;">
			<i>modified on November 7, 2003, 4:33 pm</i><br>
			</p>
