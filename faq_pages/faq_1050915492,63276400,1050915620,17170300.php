...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>Is Steam really free?</em></li></ul>
<p><br>Yes, Steam is really free.<br><br>Steam also provides access to several free products and services, like the dedicated game server, instant messaging, the game server browser, etc. <br><br>And if you've already bought Half-Life or one of the other Half-Life family of games, several add-ons are available via Steam for no extra cost.<br><br>After installing Steam, check your "Games" list to see what's available.</p>
			<p style="font-size: 10px;">
			<i>modified on July 9, 2003, 6:27 pm</i><br>
			</p>
