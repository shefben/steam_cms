...
<!-- end header -->
	...
	<div class="narrower">
	<h3>STEAM BASICS</h3>
<ul><li><em>I found a third-party download site hosting copies of CZ models and other CZ files that upgrade my copy of Counter-Strike. Can I download and use these?</em></li></ul>
<p><br>No.<br><br>Valve has not released any CZ content for re-distribution by third-parties as an upgrade to Counter-Strike. Any updates to Counter-Strike will be officially released by Valve and subject to a Valve licensing agreement.</p>
			<p style="font-size: 10px;">
			<i>modified on June 3, 2004, 10:13 am</i><br>
			</p>
