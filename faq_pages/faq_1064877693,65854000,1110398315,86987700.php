...
<ul><li><em>How can multiple users play with one license key?</em></li></ul>
<p><br>The license keys that we will issue you are tied to the accounts you set up, not the PCs themselves. So, you can have as many players as needed. If you sign up for our program, we will send you installation instructions on how to set up Steam. You can check the box that says 'remember your password' and 'start Steam when Windows launches' - that way an automatic login will pop up everytime you turn off your computers and everytime you close Steam. You can either login you&apos;re your customers or have them do it themselves.</p>
			<p style="font-size: 10px;">
			<i>modified on March 9, 2005, 11:58 am</i><br>
			</p>
