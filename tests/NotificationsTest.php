...
$pdo->exec(
    'CREATE TABLE notifications (id INTEGER PRIMARY KEY AUTOINCREMENT, type TEXT, message TEXT, target_user INT, target_role TEXT, created DATETIME, read_at DATETIME)'
);
