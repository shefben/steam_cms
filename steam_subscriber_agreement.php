...
<br>
Valve hereby grants, and you accept, a limited, non-exclusive license and right to use the Steam Software for your personal use in accordance with this Agreement and the Subscription Terms.  The Steam Software is licensed, not sold.  Your license confers no title or ownership in the Steam Software.  This license is effective until termination in accordance with this Agreement.<br>
<br>
Additionally, Valve herby grants, and you accept, a limited, terminable, non-exclusive license and right to reproduce and distribute an unlimited number of exact copies of the Steam client installation software ("Steam Installer") via online download; provided that the following conditions are met:<br>
(i)	you must redistribute the Steam Installer in its entirety;<br>
(ii)	you must not modify the Steam Installer in any way and must not integrate or combine the Steam Installer with another software program;<br>
(iii)	you must redistribute the Steam Installer on a non-commercial basis (i.e. you may not charge any fee or receive any compensation for your redistribution of the Steam Installer); <br>
(iv)	you must include this license agreement with the Steam Installer; and <br>
(v)	you must preserve in all copies of the Steam Installer all copyright and legal notices that are attached to the copy of the Steam Installer received by you pursuant to this Agreement.  <br>
<br>
B.  Beta Software Terms<br>
<br>
...
(i)	your right to use the Beta Software license is effective until the earlier of: (a) Valve ceasing to make the Beta Software accessible to you; (b) a final release of the software that corresponds to the Beta Software; or (c) termination by Valve pursuant to Section 13 below;   <br>
(ii)	certain Beta Software may be made available to you subject to additional Subscription Terms to which you must agree as a condition of use of the Beta Software;<br>
(iii)	Valve may request or require that you provide suggestions, feedback, or data regarding your use of the Beta Software, which will be deemed User Generated Information under Section 7 below; and <br>
(iv) 	in addition to the waivers and limitations of liability for all Steam Software under Section 9 below, you specifically acknowledge that Beta Software is not final and may create incompatibilities or damage to your computer, data, and/or software.  If you decide to install and/or use Beta Software, it is entirely as your risk.  <br>
<br>
C.  Source SDK.<br>
<br>
Your Subscription(s) may contain access to the Valve software development kit (the "SDK") for the computer game engine used in Half-Life 2 and other compatible Valve products (the "Source Engine").  You may use, reproduce and modify the SDK solely to develop a modified game (a "Mod") for Half-Life 2 or other Valve products compatible with and using the Source Engine.  You may reproduce, distribute and license the Mod in object code form, solely to licensed end users of Half-Life 2 or other compatible Valve products, without charge.  <br>
<br>
D.  Ownership.<br>
<br>
The Steam Software is the copyrighted work of Valve and/or its licensors.   All rights reserved, except as expressly stated herein.  The Steam Software is protected by the copyright laws of the United States, international copyright treaties and conventions and other laws.  The Steam Software contains certain licensed materials and Valves licensors may protect their rights in the event of any violation of this Agreement.<br>
<br>
E.  Restrictions.<br>
<br>
...
<br>
<h2>5. ONLINE CONDUCT, CHEATING AND ILLEGAL BEHAVIOR </h2>
