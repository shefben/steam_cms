		...
		GHomepage.FillPagedCapsuleCarousel( GHomepage.rgContentHubs, $contentHubCarousel,
			function( item, strFeature, rgOptions, nDepth )
			{
				...
				var $image = $J( '<img/>', {
					...
					"data-image-url": "https://store.fastly.steamstatic.com/" + "categories/homepageimage/" + strImageURL + "?cc=" + cc + "&l=" + l,
				} );
...
GSteamCurators = {
    ...
    BuildResponsiveHomePageGiantCap: function( strFeatureContext, oItem )
	{
        ...
        var $Thumb = $J('<img/>', {'class': 'recommendation_thumb', src: 'https://store.fastly.steamstatic.com/public/images/recommended_thumb.png'});
