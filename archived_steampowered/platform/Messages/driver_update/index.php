...
<head>
	<title>Driver Update - Unknown Vendor</title>
...
<div class="content" id="container">
	...
	<h1>DRIVER UPDATE</H1>
	<h2>UNKNOWN <em>VENDOR</em></h2><img src="/img/Graphic_box.jpg" height="6" width="24" alt=""><br>
	<div class="narrower">
		<br>

		<!-- *** start localization after here *** -->

		<p>Steam has determined that your video drivers are out of date, however we have not been able to determine which drivers you need.  Please contact your video card vendor for further information.  For your convenience, we have provided a list of the most common vendor driver pages below.</p>

		<!-- *** stop localization *** -->
		
		<ul>
<li> <a href="http://www.ati.com/support/driver.html">ATI</a></li>
<li> <a href="http://developer.intel.com/design/motherbd/gendrive.htm">Intel</a></li>
<li> <a href="http://www.nvidia.com/content/drivers/drivers.asp">NVIDIA</a></li>
<li> <a href="http://www.s3graphics.com/drivers.jsp">S3</a></li>
<li> <a href="http://www.tridentmicro.com/site/go.asp?dest=drivers">Trident</a></li>
<li> <a href="http://www.matrox.com/mga/support/drivers/home.cfm">Matrox Graphics</a></li>
</ul>
