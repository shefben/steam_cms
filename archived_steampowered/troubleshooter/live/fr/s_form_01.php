...
<tr valign="top">
	...
	<h1>Envoi d'une demande d'assistance</h1>
	<hr>
    
	<p>Si vous rencontrez un problème qui n'est pas résolu par le module de dépannage, utilisez cette page pour envoyer une demande d'assistance.<br><br>N'oubliez pas que si le problème est traité par le module de dépannage, vous bénéficiez d'une aide plus précise et rapide dans ce dernier.<br><br>Vous devrez fournir un certain nombre d'informations. Soyez aussi spécifique que possible et incluez le texte exact des messages d'erreur que vous recevez.</p>
