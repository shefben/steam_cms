...
$default_nav = [
    ['file'=>'index.php','label'=>cms_admin_label('nav_dashboard','Dashboard'),'visible'=>1],
    ['file'=>'main_content.php','label'=>cms_admin_label('nav_main_content','Main Content'),'visible'=>1],
    ['file'=>'news.php','label'=>cms_admin_label('nav_news','News'),'visible'=>1],
    ['file'=>'faq.php','label'=>cms_admin_label('nav_faq','FAQ'),'visible'=>1],
    ['file'=>'cafe_signups.php','label'=>cms_admin_label('nav_cafe_signups','Cafe Signup Requests'),'visible'=>1],
    ['file'=>'cafe_directory.php','label'=>cms_admin_label('nav_cafe_directory','Cafe Directory'),'visible'=>1],
    ['file'=>'cafe_pricing.php','label'=>cms_admin_label('nav_cafe_pricing','Cafe Pricing'),'visible'=>1],
    ['file'=>'cafe_representatives.php','label'=>cms_admin_label('nav_cafe_reps','Cafe Representatives'),'visible'=>1],
    ['file'=>'content_servers.php','label'=>cms_admin_label('nav_servers','Servers'),'visible'=>1],
    ['file'=>'contentserver_banners.php','label'=>cms_admin_label('nav_server_banners','ContentServer Banner Management'),'visible'=>1],
    ['file'=>'custom_pages.php','label'=>cms_admin_label('nav_custom_pages','Custom Pages'),'visible'=>1],
    ['file'=>'custom_titles.php','label'=>cms_admin_label('nav_custom_titles','Custom Titles'),'visible'=>1],
    ['file'=>'random_content.php','label'=>cms_admin_label('nav_random','Random Content'),'visible'=>1],
    ['file'=>'scheduled_content.php','label'=>cms_admin_label('nav_scheduled','Scheduled Content'),'visible'=>1],
    ['file'=>'theme.php','label'=>cms_admin_label('nav_theme','Theme'),'visible'=>1],
    ['file'=>'settings.php','label'=>cms_admin_label('nav_settings','Settings'),'visible'=>1],
    ['file'=>'header_footer.php','label'=>cms_admin_label('nav_header_footer','Header & Footer'),'visible'=>1],
    ['file'=>'faq_categories.php','label'=>cms_admin_label('nav_faq_categories','FAQ Categories'),'visible'=>1],
    ['file'=>'admin_users.php','label'=>cms_admin_label('nav_admins','Administrators'),'visible'=>cms_has_permission('manage_admins')?1:0],
    ['file'=>'roles.php','label'=>cms_admin_label('nav_roles','Roles'),'visible'=>cms_has_permission('manage_admins')?1:0],
    ['file'=>'activity_log.php','label'=>cms_admin_label('nav_log','Activity Log'),'visible'=>cms_has_permission('manage_admins')?1:0],
    ['file'=>'error_page.php','label'=>cms_admin_label('nav_error','Error Page'),'visible'=>1],
    ['file'=>'storefront.php','label'=>cms_admin_label('nav_storefront','Storefront'),'visible'=>1],
    ['file'=>'storefront_main.php','label'=>cms_admin_label('nav_sf_main','Main Page'),'visible'=>1],
    ['file'=>'storefront_products.php','label'=>cms_admin_label('nav_sf_products','Products'),'visible'=>1],
    ['file'=>'storefront_categories.php','label'=>cms_admin_label('nav_sf_categories','Categories'),'visible'=>1],
    ['file'=>'storefront_sidebar.php','label'=>cms_admin_label('nav_sf_sidebar','Sidebar'),'visible'=>1],
    ['file'=>'storefront_developers.php','label'=>cms_admin_label('nav_sf_developers','Developers'),'visible'=>1],
    ['file'=>'../logout.php','label'=>cms_admin_label('nav_logout','Logout'),'visible'=>1]
];
