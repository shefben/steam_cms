...
if (!in_array($theme, ['2004','2003_v2'])) {
    echo '<p>This page is only available for the 2004 or 2003_v2 themes.</p>';
...
<div class="page-group">
  ...
  <div class="page-options">
    <label>
      ...
      <span>Version 1</span><br>
      <img src="images/downloadpage_thumbnails/2004_dlv1.png" alt="Version 1">
    </label>
    <label>
      <input type="radio" name="download" value="2004_dlv3" <?php echo $current['download']=='2004_dlv3'?'checked':''; ?>><br>
      <span>Version 2</span><br>
      <img src="images/downloadpage_thumbnails/2004_dlv2.png" alt="Version 2">
    </label>
  </div>
</div>
<hr>
<div class="page-group">
  ...
  <div class="page-options">
    ...
    <label>
      <input type="radio" name="download_2003_v2" value="2004_dlv1" <?php echo $current['download_2003_v2']=='2004_dlv1'?'checked':''; ?>><br>
      <span>Version 3</span><br>
      <img src="images/downloadpage_thumbnails/2003_v2_dlv3.png" alt="Version 3">
    </label>
  </div>
</div>
<hr>
