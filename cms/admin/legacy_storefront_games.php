...
if(isset($_GET['ajax']) && $_GET['ajax']==='upload' && isset($_FILES['file'])){
    ...
    $dir=CMS_ROOT.'/04-05v1_storefront/images';
    ...
    echo '/04-05v1_storefront/images/'.$fname;
    exit;
}
...
<tr data-id="<?php echo $g['appid']; ?>">
 ...
 <td>
<?php if(preg_match('~^/04-05v1_storefront/images/~',$g['title'])): ?>
