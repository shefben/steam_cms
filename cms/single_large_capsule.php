<?php
/**
 * Single Large Capsule (2007+/2008 themes)
 * PHP adaptation of the 2007 capsule_lg.php that loads app data from database
...
function slc_fmt($v, $mode = 'currency') {
...
$theme = $_GET['theme'] ?? cms_get_setting('theme', '2007_v1');
...
foreach ($rows as $row) {
    ...
    $items[] = [
        ...
        'price' => slc_fmt($row['price'] ?? 0, 'currency'),
...
/* navigation dots (up to 12 squares) */
