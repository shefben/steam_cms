<?php $page_title = 'Counter-Strike: Condition Zero'; include 'cms/header.php'; ?>

<!-- cz -->
<div class="content" id="container">
<br><img width="533" height="129" src="/img/cz_logo.gif" alt="Counter-Strike: Condition Zero"><br>
<br>
<div class="narrower">
<h3>GET COUNTER-STRIKE: CONDITION ZERO NOW FOR $29.95!</h3>
<br>
Counter-Strike: Condition Zero&trade; advances the world&apos;s number one online action game by introducing new single-player game modes, the official CS bot, and special enhancements for online play. <br>
<br>
<div style="background:black;padding:8px;width:440px;"><center>
<img src="/img/01.cs_italy_cz0006-t.gif">&nbsp;
<img src="/img/03.de_dust_cz0006-t.gif">&nbsp;
<img src="/img/cz_screenshot.gif"></center>
</div>
<br>
...
<a href="/?area=getsteamnow"><img src="/img/but_getsteamnow.gif" height="24" width="124" alt="get steam now"></a>
<br><br>
