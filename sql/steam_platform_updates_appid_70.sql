...
-- App ID: 70
-- Generated on: 2025-08-01 23:33:57
-- MySQL/MariaDB Format



INSERT INTO `platform_update_history` (`appid`, `date`, `title`, `content`) VALUES
(70, '2003-01-16', NULL, '<div class=\"details\" id=\"January 16, 2003\" style=\"display: none;\">
Changes/Additions
	<ul>
<li> Complete rework of launcher UI.</li> <li> Improved load times to join servers.</li> <li> Engine supports masked and additive textures modes on models.</li> <li> Added widescreen monitor support (16:9 and 5:4).</li> <li> Windows HLDS now runs as a VGUI2 panel. Running with -console will run as a console window.</li> <li> Windows HLDS now loads sw.dll again, swds.dll is no longer needed.</li> <li> HLTV log files have time stamp in file name.</li> <li> Added number of ban entries to \"listid\" response to aid in parsing.</li> <li> Added server cvar \"sv_lan_rate\" which specifies the rate to use for all clients on a lan server, default is 20000.</li> <li> Added \"sv_log_onefile\" to determine whether one log file is created (total) or one log file for each map change, which is how it currently is. The default is the current behavior (one for each map change).</li> </ul>
Bug fixes
	<ul>
<li> Fixed bug where players could duck while traveling up ladders and not lose any speed (but the sound volume was reduced).</li> <li> Fixed players being able to move up ladders faster than their maxspeed.</li> <li> Fixed messagemode exploit where you could set cvars on the client without the console.</li> <li> Fixed mouse input bug when playing with very low sensitivity in Windows XP.</li> <li> Don\'t relay admin_mod commands to spectators like rate, cl_updaterate, etc.</li> <li> Removed unused latency code ( was related to pushlatency)</li> <li> Fixed demo recording after changelevel.</li> <li> Reduced default sv_maxupdaterate value from 60 to 30.</li> <li> Fixed \"fakelag\" bug that allowed people to set \"fakelag\" and then connect to a server.</li> <li> Fixed \"sv_visiblemaxplayers\" setting not working for info/details query response.</li> </ul>
</div>'),
(70, '2003-06-05', NULL, '<div class=\"details\" id=\"June 5, 2003\" style=\"display: none;\">
Changes/Additions
	<ul>
<li> Valve Anti-Cheat is now active in the Steam beta.</li> <li> Added \"servercfgfile\" cvar back into the engine.</li> <li> Changed references from woncomm.lst to valvecomm.lst.</li> <li> Added disconnect and resume buttons to the main menu.</li> <li> Added in Steam monitoring tool. This will display Steam activity on your machine.</li> <li> Update news is displayed during the launch of the game if content is being downloaded.</li> <li> Optimized protocol for Steam content delivery.</li> <li> Server browser can be refreshed using the F5 key.</li> <li> Moved muting and friends status out of the scoreboard. This is handled in the Player List section of the UI.</li> <li> You can run multiple copies of the same application now. This is most useful for Dedicated Servers.</li> <li> Added Hearts and Spades to Friends mini-games.</li> <li> Added ability to force or disable automatic updating of individual Steam titles via Games list.</li> <li> HLTV: New command \"clearbanns\" - removes all IPs from bann list.</li> <li> Added \"mapchangecfgfile\" cvar. Set this to the filename of the file you want run on map change.</li> <li> Fixed bug with pausing/starting MP3 streams when console/UI is brought up and closed again.</li> </ul>
Bug fixes
	<ul>
<li> Fixed bug with custom decals.</li> <li> Fixed bug where CD Audio CD tracks were never being played even if there was a valid CD in the drive.</li> <li> Fixed bug with pausing/starting MP3 streams when console/UI is brought up and closed again.</li> <li> Fixed bug where game could crash when initializing MSS sound thread.</li> <li> Fixed bug in server browser if you uparrow or downarrow in an empty list and then \"connect\".</li> <li> Fixed a number of bugs related to Friends messages.</li> <li> Fixed format string crash bug when logging.</li> <li> Fixed server freeze/crash exploit caused by malformed userinfo information in connect packets.</li> <li> Fixed potential exploits due to buffer overflows in infostring handling.</li> <li> HLTV: Fixed \"NULL\" player names in HLTV demos.</li> </ul>
</div>'),
(70, '2003-06-24', NULL, '<div class=\"details\" id=\"June 24, 2003\" style=\"display: none;\">
Bug fixes
	<ul>
...
(70, '2003-07-22', NULL, '<div class=\"details\" id=\"July 22, 2003\" style=\"display: none;\">
Bug fixes
	<ul>
<li> Fixed bug voice initialization would not work properly.</li> <li> Added support for speex voice codec.</li> </ul>
</div>'),
(70, '2003-08-11', NULL, '<div class=\"details\" id=\"August 11, 2003\" style=\"display: none;\">
Bug fixes
	<ul>
...
(70, '2003-09-09', NULL, '<div class=\"details\" id=\"September 9, 2003\" style=\"display: none;\">
Changes/Additions
	<ul>
...
(70, '2003-11-12', NULL, '<div class=\"details\" id=\"November 12, 2003\" style=\"display: none;\">
Changes/Additions
	<ul>
...
(70, '2003-12-10', NULL, '<div class=\"details\" id=\"December 10, 2003\" style=\"display: none;\">
Changes/Additions
	<ul>
...
Bug fixes
	<ul>
<li> Fixed problem in Direct3D mode where the game would be unavailable for some users. Direct3D mode should work now, but note that OpenGL will provide a better play experience if your video card is capable</li> <li> Fixed regression that was causing the \'load failed\' crash to happen on level change</li> </ul>
</div>'),
(70, '2004-01-15', NULL, '<div class=\"details\" id=\"January 15, 2004\" style=\"display: none;\">
Bug fixes
	<ul>
...
(70, '2004-02-09', NULL, '<div class=\"details\" id=\"February 9, 2004\" style=\"display: none;\">
Changes/Additions
	<ul>
...
(70, '2004-03-09', NULL, '<div class=\"details\" id=\"March 9, 2004\" style=\"display: none;\">
Bug fixes
	<ul>
...
(70, '2004-03-23', NULL, '<div class=\"details\" id=\"March 23, 2004\" style=\"display: none;\">
Bug fixes
	<ul>
<li> Prevent the \"connection to server lost due to level change\" error</li> </ul>
</div>'),
(70, '2004-04-02', NULL, '<div class=\"details\" id=\"April 2, 2004\" style=\"display: none;\">
Changes/Additions
	<ul>
...
(70, '2004-04-28', NULL, '<div class=\"details\" id=\"April 28, 2004\" style=\"display: block;\">
Changes/Additions
	<ul>
<li> Improved game demo recording performance under Steam</li> </ul>
</div>'),
(70, '2005-06-07', 'Hl1 Engine Update', '<div class=\"post_content\" id=\"content_422\" style=\"display: none;\">
<p>Updates to the HL1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>HL1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed several exploits triggered by malicious server operators (found by Stan Bubrouski)<br/><li>As part of the next version of VAC, which is currently in testing, the Linux game server now must have GLIBC 2.3.2 or above installed<br/></li></li></ul><br/><b>HL1 Engine Master Server Query Protocol</b><br/><i>These changes bring the HL1 engine\'s querying protocol in line with that of the Source engine. If you connect to Steam enabled game servers using a third party tool, you may need to contact the vendor for an update.</i><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Added a challenge number to A2S_PLAYER and A2S_RULES server queries.<br/><i>Setting \"sv_enableoldqueries\" to 1 (currently the default) allows old style (no challenge/response) queries to work</i><br/><li>Changed A2S_INFO server query to require the string \"Source Engine Query\" appended to the end of the query packet<br/><li>Removed support for \"info\", \"infostring\", \"details\", \"players\" and \"rules\" queries, use A2S_INFO, A2S_PLAYERS and A2S_RULES instead<br/></li></li></li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2005-08-08', 'Counter-strike And Half-life 1: Engine Update Available', '<div class=\"post_content\" id=\"content_431\" style=\"display: none;\">
<p>Updates to Counter-Strike and the Half-Life 1: Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1: Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Servers will default to starting up using VAC2<br/><li>Added \"sv_uploadmax\" cvar to limit the max size (in MB) a client can use for a custom resource (i.e spray decals)<br/><li>Added \"-sport\" command line option to allow you to specify the VAC2 port the server should use<br/><li>Don\'t allow servers to execute \"alias\" commands on clients (prevents an infinite loop exploit using alias commands from servers)<br/><li>Fixed S2C_CONNREJECT packet exploit causing the game to quit from any currently connected game server (found by Gavin Cotter)<br/><li>Fixed crash exploit caused by specially crafted packet triggering a crash in the resource upload code (found by Gavin Cotter)<br/><li>Fixed infinite loop in richtext/textentry control caused by large sets of spaces between words wrapping around line ends (found by Kristian Hermansen)<br/><li>Fixed possible lockup when refreshing a login ticket<br/><li>Disabled old style server queries by default.<br/></li></li></li></li></li></li></li></li></li></ul><br/><b>Counter-Strike</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed menu exploit on join that spawned you into the server but moved you around as you were in spectator mode<br/></li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2005-08-12', 'Half-life 1: Engine Update Available', '<div class=\"post_content\" id=\"content_435\" style=\"display: none;\">
...
(70, '2005-09-15', 'Half-life 1: Engine Update Available', '<div class=\"post_content\" id=\"content_445\" style=\"display: none;\">
...
(70, '2005-10-03', 'Source Engine And Half-life 1: Engine Updates Available', '<div class=\"post_content\" id=\"content_452\" style=\"display: none;\">
...
(70, '2005-10-11', 'Half-life 1: Engine Update Available', '<div class=\"post_content\" id=\"content_454\" style=\"display: none;\">
<p>Updates to the Half-Life 1: Engine have been released. The update will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1: Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Updated Half-Life 1 engine\'s interaction with Steam in preparation for the release of a new Steam client</li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2005-11-21', 'Half-life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_481\" style=\"display: none;\">
...
(70, '2005-11-29', 'Half-life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_485\" style=\"display: none;\">
<p>Updates to the Half-Life 1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed regression causing Asian language versions to display corrupt characters<br/></li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2005-12-07', 'Half-life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_491\" style=\"display: none;\">
<p>Updates to the Half-Life 1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed \"This Steam account is being used in another location\" error when starting a listen server with LAN mode disabled</li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2006-03-08', 'Source And Half-life 1 Dedicated Server Update Released', '<div class=\"post_content\" id=\"content_514\" style=\"display: none;\">
...
(70, '2007-01-17', 'Half-life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_909\" style=\"display: none;\">
<p>Updates to the Half-Life 1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Prevent steam:// urls from being triggered from the MOTD<br/><li>Fix for player names with really wide characters getting ellipses and being indistinguishable from one another in the scoreboard and spectator UIs</li></li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2007-03-08', 'Half-life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_971\" style=\"display: ;\">
<p>Updates to the Half-Life 1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed loading outdated client dlls</li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2007-03-08', 'Half-Life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_971\" style=\"display: none;\">
<p>Updates to the Half-Life 1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed loading outdated client dlls</li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2008-10-22', 'Half-Life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_1921\" style=\"display: none;\">
<p>A new set of Steamworks features have been released for all Half-Life 1 engine multiplayer games: Counter-Strike 1.6, Condition Zero, Team Fortress Classic, Deathmatch Classic, Ricochet, Day of Defeat and Half-life 1 Deathmatch. The update includes Steamworks features such as player avatars in the scoreboard when playing Counter-Strike and Condition Zero. The update also contains several bug fixes, listed below. Note that this update will require all game servers to restart.<br/><br/><b>Bug Fixes</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Removed the need to manually re-login and re-authenticate to Steam while in game<br/><li>Fixed a crash on startup when running windowed with a non-standard desktop resolution<br/><li>Removed the display of saytext (in-game chat text) from players whom you\'ve blocked in Steam friends<br/><li>Locked down several engine cvars to prevent malicious script exploits<br/><li>Enforced file consistency on several sprites in Counter-Strike<br/><li>Removed \"ex_extrapmax\" cvar (no longer needed)<br/></li></li></li></li></li></li></ul><br/><b>Server</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Added \"-noaff\" command-line option to disable setting of thread affinity<br/><li>Added \"bannedcfg\" cvar so admins can choose which file is written to by the \"writeid\" command<br/></li></li></ul></p>
<br clear=\"left\"/>
</div>'),
(70, '2008-10-24', 'Half-Life 1 Engine Update Released', '<div class=\"post_content\" id=\"content_1935\" style=\"display: ;\">
<p>Updates to the Half-Life 1 Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br/><br/><b>Half-Life 1 Engine</b><br/><ul style=\"padding-bottom: 0px; margin-bottom: 0px;\"><li>Fixed UI crash when running a MOD<br/></li></ul></p>
<br clear=\"left\"/>
</div>');
