<?php $page_title = 'Dormant User'; include 'cms/header.php'; ?>
<!-- dormant user form -->

<div class="content" id="container">
<h1 style="text-transform:uppercase;">xxxxxxxxxxxxxxxxx</H1>
...
<br>
We've noticed that your Steam account, <b>xxxxxxxxxxxxxxxxx</b>, hasn't been used to log into Steam in the last 30 days.<br>
<br>
...
<input type="hidden" name="account" value="xxxxxxxxxxxxxxxxx">
...
<tr onMouseOver="this.bgColor='#3E4637';" onMouseOut="this.bgColor='#4C5844';" style="cursor: pointer;">
	...
	<td valign="top" width="100%"><label for="rb1"><p style="width: 100%;">I <i>have</i> been using Steam, I just haven't been using the account <b>xxxxxxxxxxxxxxxxx</b>.</p></label></td>
</tr>
<tr>
