...
<html>
<head><title>Steam Users Forums - Installation of custom maps and add/remove programs list</title>
...
<a href="forumdisplay.php?s=2ee00daee37be73bbee37d14616a87bc&amp;forumid=5">Game Discussions</a>
<!-- END TEMPLATE: nav_linkon --><!-- BEGIN TEMPLATE: nav_joiner -->
 &gt; 
<!-- END TEMPLATE: nav_joiner --><!-- BEGIN TEMPLATE: nav_linkon -->
<a href="forumdisplay.php?s=2ee00daee37be73bbee37d14616a87bc&amp;forumid=21">Day of Defeat</a>
<!-- END TEMPLATE: nav_linkon --><!-- BEGIN TEMPLATE: nav_joiner -->
 &gt; 
<!-- END TEMPLATE: nav_joiner --><!-- BEGIN TEMPLATE: nav_linkoff -->
Installation of custom maps and add/remove programs list
...
<tr>
	...
	<a href="showthread.php?s=2ee00daee37be73bbee37d14616a87bc&amp;threadid=62041&amp;goto=nextoldest">Last Thread</a>
	&nbsp;
	<a href="showthread.php?s=2ee00daee37be73bbee37d14616a87bc&amp;threadid=62041&amp;goto=nextnewest">Next Thread</a>
...
<tr>
	...
	<tr>
		...
		<td><a href="newthread.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=newthread&amp;forumid=21"><img src="images/newthread.gif" border="0" alt="Post New Thread"></a></td>
		<td><font face="verdana, arial, helvetica" size="2" >&nbsp;&nbsp;</font></td>
		<td><a href="newreply.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=newreply&amp;threadid=62041"><img src="images/reply.gif" border="0" alt="Post A Reply"></a></td>
	</tr>
	</table>
	<!-- /Thread nav and post images -->
	</td>
...
<!--
 ...
 -->
	...
	<font face="verdana,arial,helvetica" size="1" > <b>Installation of custom maps and add/remove programs list</b></font>
	<p><font face="verdana, arial, helvetica" size="2" >I play custom maps in DoD quite a bit. I generally download these maps seperately and adjust the auto installer install directory accordingly to get the files in the right place. <br />
<br />
Recently, however, I was going through my add/remove programs list and found 2 listings. One for each of the maps I had most recently installed. I don't really see this as unusual until I notice that no other maps are listed AND there size is 1,528.00MB each! Then I look at Steam and it is rated at over 3,000MB.<br />
<br />
Could someone theorize on what is going on here? Is it just DoD and Counter-Strike installs with incorrect names? Is it something else. These programs listings are WAY too big to be the maps I installed (obviously).<br />
<br />
EDIT: I would also like to add that this has been reported by at least 1 other person who has virtually the same issue. That said, check your program listings and see what it says. Does it look the same?</font></p>
	
	<p></p>
	<p><!-- BEGIN TEMPLATE: postbit_editedby -->
<font face="verdana,arial,helvetica" size="1" ><i>Last edited by Davisio on 03-07-2004 at 06:16 PM</i></font>
<!-- END TEMPLATE: postbit_editedby --></p>
	<p align="right"><font face="verdana,arial,helvetica" size="1" ><a href="report.php?s=2ee00daee37be73bbee37d14616a87bc&amp;postid=414016">Report this post to a moderator</a> | <!-- BEGIN TEMPLATE: postbit_ip_hidden -->
IP: <a href="postings.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=getip&amp;postid=414016">Logged</a>
...
<tr>
	...
	03-07-2004 <font color="#D8DED3">06:08 PM</font></font></td>
...
<a href="member.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=getinfo&amp;userid=15323" target="_blank"><img src="images/profile.gif" border="0" alt="Click Here to See the Profile for Davisio"></a>
<!-- END TEMPLATE: postbit_profile --> <!-- BEGIN TEMPLATE: postbit_sendpm -->
<a href="private.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=newmessage&amp;userid=15323"><img src="images/sendpm.gif" border="0" alt="Click here to Send Davisio a Private Message"></a>
<!-- END TEMPLATE: postbit_sendpm -->   <!-- BEGIN TEMPLATE: postbit_search -->
<a href="search.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=finduser&amp;userid=15323"><img src="images/find.gif" border="0" alt="Find more posts by Davisio"></a>
<!-- END TEMPLATE: postbit_search --> <!-- BEGIN TEMPLATE: postbit_buddy -->
<a href="member2.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=addlist&amp;userlist=buddy&amp;userid=15323"><img src="images/buddy.gif" border="0" alt="Add Davisio to your buddy list"></a>
<!-- END TEMPLATE: postbit_buddy -->
			<!-- $ post[icqicon] --> <!-- $ post[aimicon] --> <!-- $ post[yahooicon] --> 
			</font></td>
			<td align="right" nowrap><font face="verdana,arial,helvetica" size="1" >
			<a href="editpost.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=editpost&amp;postid=414016"><img src="images/edit.gif" border="0" alt="Edit/Delete Message"></a>
			<a href="newreply.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=newreply&amp;postid=414016"><img src="images/quote.gif" border="0" alt="Reply w/Quote"></a>
			</font></td>
		</tr>
		</table>
	</td>
...
<!--
	...
	<font face="verdana, arial, helvetica" size="2" ><b>{GL}DoubleD</b></font><br>
 ...
 -->
	...
	<p><font face="verdana, arial, helvetica" size="2" >well, some self-installers create uninstallers.<br />
<br />
So, when you feel like uninstalling some maps, you could easily just run the uninstaller and it'd delete those specific maps.<br />
<br />
Now, the file-size. The file size that shows on the add/remove program thingie gets its number from the FOLDER in which the program (or file) is installed. The map itself is probably only about 5 megs big. But your maps folder is most likely 1,528 MBs. (1.5 gigs, roughly). That is why both maps show the same size, because they (and their uninstallers) are located in the same directory. Also, you'll notice weird file-sizes on other programs. Some games will only show sizes like "327 kbs" or "4,300 kbs" when in reality the game takes up 2-3 gigs of space. That's caused of the same reason. The uninstaller is probably placed in a seperate folder within the game's folder, so it doesn't read the rest of the material, thus creating a small size (whatever's in the folder it's in) ... get the drift?<br />
<br />
Steam is, in fact, over 3 gigs big. That's just the way steam is, lol...<br />
<br />
So, those two maps are not sucking up all your space... just your custom maps and steam in general are! =b</font></p>
	
	<p></p>
	<p><!-- BEGIN TEMPLATE: postbit_editedby -->
<font face="verdana,arial,helvetica" size="1" ><i>Last edited by {GL}DoubleD on 03-07-2004 at 06:42 PM</i></font>
<!-- END TEMPLATE: postbit_editedby --></p>
	<p align="right"><font face="verdana,arial,helvetica" size="1" ><a href="report.php?s=2ee00daee37be73bbee37d14616a87bc&amp;postid=414095">Report this post to a moderator</a> | <!-- BEGIN TEMPLATE: postbit_ip_hidden -->
IP: <a href="postings.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=getip&amp;postid=414095">Logged</a>
<!-- END TEMPLATE: postbit_ip_hidden --></font></p>
	</td>
</tr>
<tr>
	<td bgcolor="#3E4637" width="175" height="16" nowrap><font face="verdana,arial,helvetica" size="1" ><img src="images/posticon.gif" border="0" alt="Old Post">
	03-07-2004 <font color="#D8DED3">06:38 PM</font></font></td>
	
	<td bgcolor="#3E4637" width="100%" valign="middle" height="16">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="bottom">
			<td><font face="verdana,arial,helvetica" size="1" ><!-- BEGIN TEMPLATE: postbit_offline -->
<img src="images/off.gif" border="0" alt="{GL}DoubleD is offline" align="absmiddle">
<!-- END TEMPLATE: postbit_offline -->
			<!-- BEGIN TEMPLATE: postbit_profile -->
<a href="member.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=getinfo&amp;userid=26186" target="_blank"><img src="images/profile.gif" border="0" alt="Click Here to See the Profile for {GL}DoubleD"></a>
<!-- END TEMPLATE: postbit_profile --> <!-- BEGIN TEMPLATE: postbit_sendpm -->
<a href="private.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=newmessage&amp;userid=26186"><img src="images/sendpm.gif" border="0" alt="Click here to Send {GL}DoubleD a Private Message"></a>
<!-- END TEMPLATE: postbit_sendpm -->  <!-- BEGIN TEMPLATE: postbit_homepage -->
<!--<a href="http://www.generalsoflegend.us" target="_blank"><img src="images/home.gif" alt="Visit {GL}DoubleD's homepage!" border="0"></a>-->
<!-- END TEMPLATE: postbit_homepage --> <!-- BEGIN TEMPLATE: postbit_search -->
<a href="search.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=finduser&amp;userid=26186"><img src="images/find.gif" border="0" alt="Find more posts by {GL}DoubleD"></a>
<!-- END TEMPLATE: postbit_search --> <!-- BEGIN TEMPLATE: postbit_buddy -->
<a href="member2.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=addlist&amp;userlist=buddy&amp;userid=26186"><img src="images/buddy.gif" border="0" alt="Add {GL}DoubleD to your buddy list"></a>
<!-- END TEMPLATE: postbit_buddy -->
			<!-- $ post[icqicon] --> <!-- $ post[aimicon] --> <!-- $ post[yahooicon] --> 
			</font></td>
			<td align="right" nowrap><font face="verdana,arial,helvetica" size="1" >
			<a href="editpost.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=editpost&amp;postid=414095"><img src="images/edit.gif" border="0" alt="Edit/Delete Message"></a>
			<a href="newreply.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=newreply&amp;postid=414095"><img src="images/quote.gif" border="0" alt="Reply w/Quote"></a>
			</font></td>
		</tr>
		</table>
	</td>
...
<tr>
	...
	<a href="printthread.php?s=2ee00daee37be73bbee37d14616a87bc&amp;threadid=62041">Show Printable Version</a> |
	<img src="images/sendtofriend.gif" alt="" border="0" align="absmiddle">
	<a href="sendtofriend.php?s=2ee00daee37be73bbee37d14616a87bc&amp;threadid=62041">Email this Page</a> |
	<img src="images/subscribe.gif" alt="" border="0" align="absmiddle">
	<a href="member2.php?s=2ee00daee37be73bbee37d14616a87bc&amp;action=addsubscription&amp;threadid=62041">Subscribe to this Thread</a>
	</font></td>
</tr>
</table>
</td></tr></table>
...
<form action="threadrate.php" method="get"><tr><td>
	...
	<input type="hidden" name="threadid" value="62041">
