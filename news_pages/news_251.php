...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=251" style="text-decoration: none; color: #BFBA50;">Small Condition Zero Steam Update Tonight</a></h3>
<span style="font-size: 9px;">March 24, 2004, 7:18 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A small update to Counter-Strike: Condition Zero has just been released:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added bot navigation files for the standard Counter-Strike maps (for Condition Zero servers)</li><br><li>Enabled bots on Linux CZ servers</li><br></ul><br>CZ dedicated server admins will need to update & restart their servers.<br></p>
