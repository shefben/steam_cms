...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=428" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source Update Available</a></h3>
<span style="font-size: 9px;">July 13, 2005, 4:46 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to Counter-Strike: Source has been released. The update will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Counter-Strike: Source</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed model scale problem resulting in under-sized players<br><li>Fixed model's feet sliding while running<br><li>Made the new Terrorist model leaner<br></ul><br></p>
