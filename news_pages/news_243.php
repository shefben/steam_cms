...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=243" style="text-decoration: none; color: #BFBA50;">Yesterday's Update & Today's DDOS Attack</a></h3>
<span style="font-size: 9px;">March 4, 2004, 3:12 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
This morning at about 8:30 PST, Steam was hit by a distributed denial of service attack. For about two and a half hours, Steam and its games were unavailable to users. We have since fixed the problem, and player numbers have returned to a normal state.<br><br>Steam's content servers are still busy with yesterday's update, but for the most part Steam users have been able to get up and running without problems.<br><br>The new email validation feature has been causing some users confusion. Our network problems have caused the validation emails to be delivered too slowly -- if you are waiting to receive your automated email response from Steam, please give it some time. We're sorry if this is causing inconvenience; the delivery speed will be improved soon.<br><br>Let us know if you're experiencing any other problems.<br></p>
