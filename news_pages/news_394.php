...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=394" style="text-decoration: none; color: #BFBA50;">Source Dedicated Server Update</a></h3>
<span style="font-size: 9px;">February 18, 2005, 4:37 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">cliffe</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Source Dedicated Server update is available and will be applied automatically when Steam is restarted. The changes include:<br><br><b>Source Dedicated Server</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added Half-Life 2: Deathmatch to the dedicated server UI</li><br><li>Temporarily disabled SourceTV beta for backend changes</li><br></ul><br></p>
