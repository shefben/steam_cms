...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=40" style="text-decoration: none; color: #BFBA50;">Counter-Strike Beta Update Released</a></h3>
<span style="font-size: 9px;">August 13, 2004, 3:12 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to the Counter-Strike: Source beta has been released to cyber cafes that subscribe to the Valve Cyber Caf&eacute; Program. Steam will update itself automatically when restarted, and servers also need to be restarted. <br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>COUNTER-STRIKE: SOURCE CHANGES / ADDITIONS:</b><br><li>Improved Steam behavior for listen servers behind a NAT device<br><li>Improved load behavior before content is ready<br><li>Eliminated grenade jumping</ul><br></p>
