...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=236" style="text-decoration: none; color: #BFBA50;">Steam Localization Update</a></h3>
<span style="font-size: 9px;">February 12, 2004, 7:08 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
There has been a small update released to Steam this evening.<br><br>This release only affects the non-English versions of the game, where there were a few lines of text that were incorrectly being shown in English.<br></p>
