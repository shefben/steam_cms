...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=39" style="text-decoration: none; color: #BFBA50;">Phase 2 of CS: Source Beta Opens Today</a></h3>
<span style="font-size: 9px;">August 18, 2004, 4:53 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Phase 2 of the Counter-Strike: Source beta begins today at 7pm PST, extending the beta to owners of Counter-Strike: Condition Zero and the ATIHL2 bundle.<br><br>Also included in this portion of the beta is a Valve Source technology benchmark. The benchmark will be available to all beta participants via the main menu. Results will be displayed upon completion, and beta participants will then have the option to send the results to a Valve-hosted public web page tracking the results as done in prior Valve surveys. <br><br></p>
