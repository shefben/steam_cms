...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=238" style="text-decoration: none; color: #BFBA50;">Friends Network Down for Maintenance</a></h3>
<span style="font-size: 9px;">February 27, 2004, 5:40 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Friends will be down for the next few hours for some server maintenance. An upgrade is being deployed to improve the reliability of the service. Sorry for the inconvenience, and thanks for your patience.<br></p>
