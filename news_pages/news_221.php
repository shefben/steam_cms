...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=221" style="text-decoration: none; color: #BFBA50;">Steam Client Update Released</a></h3>
<span style="font-size: 9px;">December 15, 2003, 3:48 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A small Steam update was released earlier today. There were only a couple of changes in this release:<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed problem with command-line parameters not being passed through correctly (for shortcuts to launching steam games)</li><br><li>Optimized some Steam networking code and decreased startup time</li><br></ul><br></p>
