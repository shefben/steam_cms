...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=16" style="text-decoration: none; color: #BFBA50;">Gamespy previews DoD retail</a></h3>
<span style="font-size: 9px;">April 4, 2003, 12:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
"Activision unveils plans to ship the popular Half-Life modification to a store near you, and announces a new partnership with Valve Software."<br><br>To read the story, <a href="http://www.gamespy.com/previews/april03/dayofdefeat/" target="_blank">click here</a>.<br></p>
