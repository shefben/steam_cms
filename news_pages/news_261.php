...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=261" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Condition Zero  1.1  and Steam Games Updated</a></h3>
<span style="font-size: 9px;">April 28, 2004, 6:03 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
The official 1.1 update for CS:CZ has been released, and all other Steam games have been updated. Here's a list of what's included.<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><B>COUNTER-STRIKE: CONDITION ZERO</B><br><li>New high-definition player models<br><li>New high-definition weapon models<br><li>New high-definition sound effects<br><li>New Buy Package system<br><li>Custom Mission Pack support<br><li>Updated de_stadium_cz<br><li>Updated de_dust_cz<br><li>Added solid radar option<br><li>Various other improvements<br><br><b>COUNTER-STRIKE</b> <br><li>Added solid radar option<br><li>Improved flashbangs (will not cancel out other flashbangs)<br><li>Updated German localized files<br><li>Various other improvements<br><br><b>ALL STEAM GAMES</b><br><li>Improved game demo recording performance under Steam</ul><br></p>
