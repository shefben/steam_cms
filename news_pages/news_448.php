...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=448" style="text-decoration: none; color: #BFBA50;">Source engine update released</a></h3>
<span style="font-size: 9px;">September 26, 2005, 12:19 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Greg Coomer</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A small update has just been released which will correct a Source engine DirectX configuration problem. The <i>DirectX 9.0c End-User Runtime</i> from Microsoft is required. When launching a Source engine game on Steam, users who don't have this latest version of DirectX will be directed to <a href="http://www.microsoft.com/directx">this page</a> to get the installer.<br></p>
