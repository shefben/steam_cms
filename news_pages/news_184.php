...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=184" style="text-decoration: none; color: #BFBA50;">Counter-Strike 1.6 Steam Installer Released</a></h3>
<span style="font-size: 9px;">September 15, 2003, 5:05 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
In addition to the Steam Client and Dedicated Server files released earlier this week, we are now releasing the Counter-Strike 1.6 Steam Installer, which includes all of the content necessary to play CS. Please check the "Get Steam Now" page for download locations.<br></p>
