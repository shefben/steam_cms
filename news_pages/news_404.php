...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=404" style="text-decoration: none; color: #BFBA50;">Source Dedicated Server Update</a></h3>
<span style="font-size: 9px;">March 10, 2005, 3:25 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update has been released for the Windows dedicated game server which addresses some issues found in yesterday's release. The Linux dedicated server and other products are unaffected. Server administrators can either restart Steam or run the HLDS update tool to receive the update.<br><br></p>
