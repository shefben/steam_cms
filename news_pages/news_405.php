...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=405" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source and Source Engine Updates Available</a></h3>
<span style="font-size: 9px;">March 23, 2005, 5:46 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update is available for Counter-Strike: Source and the Source Engine. The update will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Counter-Strike: Source</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added buy favorite system<br><li>Added location names to voice chat<br><li>Soundscape files will be loaded properly for custom maps<br><li>Fixed tinnitus effect for HE grenades playing twice<br><li>Fixed the Five-Seven's price not matching the value in the buy menu<br><li>Fixed case where money and chat HUD icons sometimes being the wrong color at round start<br><li>Target IDs will no longer show when mp_fadetoblack is active<br><li>When mp_humanteam is active human teams will be allowed to spectate<br><li>The "hostage" field of the "hostage_rescued" event is filled in correctly<br><li>Equipping the silencer is canceled if the player switches weapons<br><li>Fixed problems with the hostage shack door in cs_compound<br><li>Fixed "Hostage Rescue Zone" not showing up properly in chat and under the radar<br><li>Players can only change their names once every 10 seconds, with a max of 5 times every 10 minutes<br><li>"Enemy Spotted" hint text doesn't show for players behind smoke clouds<br><li>Flashbang effect can't be reduced by hitting escape or turning off the HUD<br></ul><br><b>Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed registry handle leak in VCR mode<br><li>Added explicit engine error when trying to render too many decals in a frame<br><li>Sound files will work properly when in a packfile now.<br></ul><br></p>
