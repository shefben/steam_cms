...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=366" style="text-decoration: none; color: #BFBA50;">Source Engine Update Released</a></h3>
<span style="font-size: 9px;">December 1, 2004, 8:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Source Engine update is available and will be applied automatically when Steam is restarted. The change includes:<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed clients being able to kick other clients from a server<br></ul><br></p>
