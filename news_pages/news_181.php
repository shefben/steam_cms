...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=181" style="text-decoration: none; color: #BFBA50;">Steam Dedicated Server Release Tonight; Steam Client Tomorrow</a></h3>
<span style="font-size: 9px;">September 10, 2003, 12:07 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
We've been making final changes to the Steam network throughout the night. Unfortunately, it's taken longer than we planned. However, the Steam dedicated server will be released this evening, and the Steam client release is now scheduled for tomorrow.<br><br>We're working to get the release out as fast as we can -- sorry for the delay, and thanks for your patience.<br></p>
