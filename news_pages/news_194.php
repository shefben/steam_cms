...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=194" style="text-decoration: none; color: #BFBA50;">Steam Update - Friends Back Online</a></h3>
<span style="font-size: 9px;">September 22, 2003, 6:32 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Steam update has just been released which brings the Friends servers back online. If you haven't already done so, you'll need to exit and restart Steam -- your Steam client will then automatically update itself and you'll be able to sign in to Friends again.<br></p>
