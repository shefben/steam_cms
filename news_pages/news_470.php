...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=470" style="text-decoration: none; color: #BFBA50;">Rag Doll Kung Fu Update Released</a></h3>
<span style="font-size: 9px;">October 26, 2005, 4:45 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to Rag Doll Kung Fu have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Rag Doll Kung Fu</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>online server list has many improvements, including search for friends, and various filters<br><li>camera bug fixed (when you die, you can click to zoom to other players for differnt veiws) <br><li>added a chat log <br><li>mouse sensitivity now gets saved<br><li>missing text bug fix <br><li>open UDP ports problem fixed<br></ul><br> <br></p>
