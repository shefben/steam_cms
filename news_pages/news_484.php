...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=484" style="text-decoration: none; color: #BFBA50;">Rag Doll Kung Fu Update Released</a></h3>
<span style="font-size: 9px;">November 28, 2005, 2:20 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to Rag Doll Kung Fu have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Rag Doll Kung Fu</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Enabled setting max players mid game, to stop people joining if it would disrupt a good game<br><li>Rebalanced the damage calculations, based on feedback from forums<br><li>Hands now do more damage than before, and combo hits now do less damage each consecutive hit, to stop the deadly phenomena that has been nicknamed 'spamming'<br></ul><br><br></p>
