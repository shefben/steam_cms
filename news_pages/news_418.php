...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=418" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source, Steam Client, and Source Engine Updates Available</a></h3>
<span style="font-size: 9px;">May 23, 2005, 4:33 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to Steam, Counter-Strike: Source, and the Source Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Counter-Strike: Source</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed hang bug when shooting grates<br><li>Re-released changes from Thursday's update</ul><br><b>Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed an intermittent crash ("failed to open models\gman_high.vvd") in Half-Life 2</ul><br><b>Steam</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added an indicator in settings UI displaying current authentication status for multiplayer games<br><li>Fixed a game crash which occurred when trying to write to special filenames reserved by Windows<br></ul><br></p>
