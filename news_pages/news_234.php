...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=234" style="text-decoration: none; color: #BFBA50;">Friends and Server Browser Update Released</a></h3>
<span style="font-size: 9px;">February 3, 2004, 7:10 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A small Steam update has been released this evening. There aren't any game changes in this release -- it includes Steam client changes only. <br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed a Friends bug which caused it to sign in to the Friends servers too often.</li><br><li>Fixed a bug in the Server browser where favorites couldn't be deleted.</li><br></ul><br></p>
