...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=447" style="text-decoration: none; color: #BFBA50;">Steam Update Released</a></h3>
<span style="font-size: 9px;">September 23, 2005, 12:06 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">cliffe</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to Steam have been released. The update will be applied automatically when your Steam client is restarted. This release includes a number of very specific CPU and memory footprint optimizations brought over from the Half-Life 2: XBOX development codebase. The release also includes all of the engine groundwork to enable the Day of Defeat: Source launch that will happen Monday, September 26 at 3:00 PDT. <br></p>
