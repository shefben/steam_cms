...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=432" style="text-decoration: none; color: #BFBA50;">Steam Client Update Available</a></h3>
<span style="font-size: 9px;">August 9, 2005, 4:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to the Steam Client have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Steam</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>We're refreshing the survey data again. The results will be tallied over at <a target=_new href="http://www.steampowered.com/status/survey.html">http://www.steampowered.com/status/survey.html</a><br><li>Fixed favorites list not refreshing on startup<br><li>Fixed Counter-Strike: Source servers showing up in Counter-Strike list on startup<br></ul><br><br><br></p>
