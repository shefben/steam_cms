...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=391" style="text-decoration: none; color: #BFBA50;">Source Engine Update Released</a></h3>
<span style="font-size: 9px;">February 2, 2005, 6:50 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">cliffe</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Source Engine update is available and will be applied automatically when Steam is restarted. The changes include: <br><br><b>Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed "exec" exploit that used ":", "\\", and ":" in the paths<li>Fixed exploit with "record", "bench_start", and "logsdir"</li></ul>      <br><br></p>
