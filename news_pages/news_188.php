...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=188" style="text-decoration: none; color: #BFBA50;">Login Failures</a></h3>
<span style="font-size: 9px;">September 17, 2003, 1:17 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Some people might be getting the following message when attempting to login to Steam:<br><br><em>"Login to steam failed.  Either the specified account does not exist, or the password was wrong.  Please check your email address and password and try again."</em><br><br>This is a bit misleading - your account exists and is fine.  The authentication servers are under heavy load right now.  This problem should be resolved shortly.  Thanks for your patience!<br></p>
