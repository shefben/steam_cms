...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=31" style="text-decoration: none; color: #BFBA50;">CONDITION ZERO DEVELOPER CHATS WITH PC.INSIDEGAMER.COM</a></h3>
<span style="font-size: 9px;">May 22, 2004, 10:00 am &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
<em>CS:CZ</em> developer and Turtle Rock Studios head honcho Michael Booth shares with the online with the publication on the new, upcoming features of <em>Condition Zero</em>. <a href="http://pc.insidegamer.nl/ShowContent.asp?ContentID=15869" target="_blank">Click here</a> to read the interview.<br></p>
