...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=186" style="text-decoration: none; color: #BFBA50;">New Installers Available</a></h3>
<span style="font-size: 9px;">September 16, 2003, 8:11 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
We've released new Steam installers that include cache files for Counter-Strike, Day of Defeat, Team Fortress Classic, and other games.  Please check the Get Steam Now page for more details.<br></p>
