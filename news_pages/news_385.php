...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=385" style="text-decoration: none; color: #BFBA50;">Steam, Source Engine, HLDS Update Released</a></h3>
<span style="font-size: 9px;">January 6, 2005, 5:48 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">cliffe</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Steam, Source Engine, and Half-Life Dedicated Server updates are available and will be applied automatically when Steam is restarted. The changes include:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>Steam</b><br><li>Pressing the cancel button while Steam is loading will bring up the offline dialog<br><li>Fixed 100% CPU use on startup<br><li>Fixed use of quoted parameters in "-applaunch" command lines<br></ul><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>Source Engine</b><br><li>Fixed exception info spam in debugger output window for SDK users<br></ul><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>Half-Life Dedicated Server</b><br><li>Enabled support for new query protocol (fixes HLTV server not appearing in the server browser)<br></ul><br><b>Update</b> - Fixed command line parameters being ignored when using desktop shortcuts for some games<br><br></p>
