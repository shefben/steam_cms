...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=43" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source Beta Pre-Loading to Cyber Caf&eacute;s</a></h3>
<span style="font-size: 9px;">August 10, 2004, 12:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Pre-loading of the Counter-Strike: Source Beta to cyber caf&eacute;s begins today. On Wednesday, this first phase of the beta will open and the game will be playable at all cyber cafes that subscribe to the Valve Cyber Caf&eacute; Program. Later this month, the beta will be extended to owners of Counter-Strike&trade;: Condition Zero&trade; and ATI Fulfillment Coupon holders.<br><br>This beta serves as a compatibility test of the Source engine as we near completion of development on Half-Life 2 and Counter-Strike: Source. During this limited-time beta, issues can be reported using the in-game bug-reporting tool. In addition any crashes will automatically generate a report back to Valve&apos;s bug database. We thank everyone for their participation, and we hope Half-Life 2 and Counter-Strike: Source live up to your expectations.<br></p>
