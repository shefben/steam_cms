...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=20" style="text-decoration: none; color: #BFBA50;">DoD on HomeLAN</a></h3>
<span style="font-size: 9px;">April 30, 2003, 12:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
HomeLAN chats with Valve's John Morello II and Doug Lombardi as they talk about the forthcoming retail release of the popular WWII multiplayer Half-Life mod Day of Defeat. To check out the interview, <a href="http://www.homelanfed.com/index.php?id=13879" target="_blank">click here</a>!<br></p>
