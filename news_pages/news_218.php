...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=218" style="text-decoration: none; color: #BFBA50;">Steam Client Update to be Released Tomorrow</a></h3>
<span style="font-size: 9px;">December 3, 2003, 3:21 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update for the Steam client will be released tomorrow morning. After it's released, the changes listed below will take effect as soon as you restart Steam.<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed bug that would cause Steam to lock up for a long period on version roll</li><br><li>Fixed "CacheFixedFileDirectory" crash</li><br><li>Fixed problem on version roll when cache was marked as read only</li><br><li>Added e-mail address confirmation in Steam when creating an account</li><br><li>Fixed crash on shutdown of Steam</li><br><li>Tighter checking for typos when entering a WON CD-Key</li><br><li>Catch cache corruption errors earlier on launch</li><br><li>Added a new cd-key authorization step when adding a game to the 'My Games' list</li><br></ul><br></p>
