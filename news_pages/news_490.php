...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=490" style="text-decoration: none; color: #BFBA50;">Source Dedicated Server Update Released</a></h3>
<span style="font-size: 9px;">December 5, 2005, 6:25 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to the Source Dedicated Server have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Source Dedicated Server</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixes incorrect Steam ID logging on player connect<br><li>Fixes rare assert on player connect<br><li>Fixes <i>srcds_i486</i> Linux binary not loading correctly<br></ul><br><br></p>
