...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=276" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source Beta 1 Coming Soon!</a></h3>
<span style="font-size: 9px;">July 7, 2004, 4:11 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Starting later this summer, Valve will be conducting a limited-time beta of Counter-Strike: Source via Steam. The beta will first be open to subscribers of the Valve Cyber Caf&eacute; Program, and then extended to owners of Counter-Strike: Condition Zero. The next installment of the world's number 1 online action game, Counter-Strike: Source blends CS's intense teamplay with the advanced technology of Valve's Source engine<br><br><i>update: Check out the <a href="/?area=css_b1">Counter-Strike: Source beta 1 FAQ</a>.</i><br></p>
