...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=435" style="text-decoration: none; color: #BFBA50;">Half-Life 1: Engine Update Available</a></h3>
<span style="font-size: 9px;">August 12, 2005, 5:11 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to the Half-Life 1: Engine for Linux have been released. Run the hldsupdatetool to apply the update. The specific changes include:<br><br><b>Half-Life 1: Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed crash on startup due to bad hostname settings<br><li>Fixed crash on startup in threading library<br></ul><br></p>
