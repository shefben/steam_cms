...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=47" style="text-decoration: none; color: #BFBA50;">Counter-Strike Beta Update Released</a></h3>
<span style="font-size: 9px;">August 23, 2004, 7:58 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to the Counter-Strike: Source beta has just been released. Steam will update itself automatically when you restart. Here is a list of the changes:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>COUNTER-STRIKE: SOURCE BETA CHANGES / ADDITIONS:</b><br><li>Fixed players being able to trigger a screen shake on other players<br><li>Fixed Shift-F1 debug panel being accessible when cheats are disabled<br><li>Fixed server browser not being displayed<br><li>Improved refresh rate selection behavior</ul><br></p>
