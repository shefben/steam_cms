...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=409" style="text-decoration: none; color: #BFBA50;">Winning Maps and Source Games Update Available Now</a></h3>
<span style="font-size: 9px;">April 13, 2005, 6:12 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Three Half-Life 2: Deathmatch maps are now available via Steam. These maps were created by the three players who won our recent HL2:DM mapping contest. If you have HL2:DM installed in your Steam games list, you will receive the new maps automatically.<br><br>The new maps are:<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Winner: dm_underpass by Scott M Jordan, USA <br><li>1st Runner Up: dm_resistance* by Jonathan Linker, Germany <br><li>2nd Runner Up: dm_powerhouse by Michael Schulz, Germany<br></ul><br>This release also includes a Counter-Strike: Source update which fixes incorrect player names appearing in the scoreboard.<br><br><i>*Based upon "Bodies" from Blood.</i><br><br><br></p>
