...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=403" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source, Source Engine, and Source SDK Updates Available</a></h3>
<span style="font-size: 9px;">March 9, 2005, 4:36 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update is available for Counter-Strike: Source, the Source Engine, and the Source SDK. The update will be applied automatically when your Steam client is restarted. The specific changes include:<br> <br><b>CS:S</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed an issue which was affecting player movement prediction<br><li>Stopped players on de_dust2 being able to hide inside of rocks<br><li>Added clipbrushes to de_train to prevent players from reaching certain areas<br><li>Enabled bots to navigate their way out of the carts in cs_compound<br></ul><br><b>Source Engine (game server changes)</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added "stats" command to print the current cpu usage, players and net bandwidth in use<br><li>Fixed rcon responses to properly reflect request id's<br><li>Added rate-limiting to connectionless queries to prevent flooding (as in HL1, the rate-limiting is controlled via the cvars: <i>sv_max_queries_sec</i>, <i>sv_max_queries_sec_global</i>, and <i>sv_max_queries_window</i>)<br><li>Removed <i>sv_allowlocalquery</i> cvar<br></ul><br><b>Source SDK</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added Snow and rain materials<br><li>Added qc_eyes.exe<br><li>Made various improvements and fixes to .FGD files<br><li>Fixed an issue in Vrad which was causing visible artifacts when lighting very large objects/areas<br><li>Fixed an issue in Studiomdl which was allowing bad $modelnames to be used<br><li>Fixed the "cordon" texture used by Hammer<br></ul><br></p>
