...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=203" style="text-decoration: none; color: #BFBA50;">HLTV Update Released</a></h3>
<span style="font-size: 9px;">October 14, 2003, 7:21 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update has just been released which fixes HLTV. (HLTV is the proxy server which enables server admins to let large numbers of people spectate games in progress.) When admins restart their dedicated servers, this update will take effect automatically<br><br>In the server browser, try using the "Spectate" tab to find HLTV servers.<br></p>
