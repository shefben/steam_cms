...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=275" style="text-decoration: none; color: #BFBA50;">CZ, CS Update Released</a></h3>
<span style="font-size: 9px;">June 28, 2004, 6:08 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update for CS:CZ and Counter-Strike has just been released. This release features three previously unreleased bonus missions for Condition Zero Deleted Scenes. Steam will update itself automatically when you restart. Here is a list of the additions:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><B>COUNTER-STRIKE: CONDITION ZERO DELETED SCENES:</B><br><li>Added previously unreleased missions Miami Heat, Truth in Chaos, and Run<br><br><B>COUNTER-STRIKE:</B><br><li>Improved behavior of team_say <br><li>Server prints team and player info in the console for chat messages<br><li>Improved memory efficiency of hitbox animations to address intermittent server lag</ul><br>Additionally, work is under way to transition players from WON to Steam. WON authentication servers will be phased out by the end of summer. If you have not already done so, you can download Steam <a href="getsteamnow.php">here</a>.<br></p>
