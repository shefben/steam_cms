...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=209" style="text-decoration: none; color: #BFBA50;">Steam Update Released</a></h3>
<span style="font-size: 9px;">November 5, 2003, 6:17 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Steam update has been released this evening. From now on Steam will be updated each Wednesday night at 7:00 PST.<br><br>Tonight's release includes some minor fixes to Steam.<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed change password dialog not displaying properly.</li><br><li>Fixed problem where some resources were not being automatically updated.</li></ul><br></p>
