...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=248" style="text-decoration: none; color: #BFBA50;">Steam Update Tonight</a></h3>
<span style="font-size: 9px;">March 22, 2004, 7:35 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A few changes to the Steam client have just been released. When you restart Steam, it will automatically update itself. Here's a list of what's included:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Suspended preloading of Condition Zero unless user has already purchased the game</li><br><li>Changed account name creation to disallow non-standard characters</li><br><li>Optimized startup time for installations that included more than one account</li><br><li>Improved authentication to handle Steam "tickets" which had become invalid</li><br></ul><br></p>
