...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=29" style="text-decoration: none; color: #BFBA50;">TURTLE ROCK STUDIOS INTERVIEW</a></h3>
<span style="font-size: 9px;">May 22, 2004, 9:58 am &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Homelan fed with Turtle Rock Studios founder / lead programmer Michael Booth: <em class="newsquote">"Valve was pretty fearless in stepping back, looking critically at CZ, and making a bold decision to change direction-- recommending we take the proven CS Bot AI and build a game around it that fulfills the original goal of CZ – providing an exciting single player 'Counter-Strike' experience."</em> To read more, <a href="http://www.homelanfed.com/index.php?id=18013" target="_blank">click here</a>.<br></p>
