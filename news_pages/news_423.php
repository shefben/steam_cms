...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=423" style="text-decoration: none; color: #BFBA50;">Steam Client and Source Engine Updates Available</a></h3>
<span style="font-size: 9px;">June 14, 2005, 5:44 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to the Steam Client and the Source Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Steam Client and Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed a number of connection problems to the backend of VAC2 (Valve's anti-cheat technology for game servers). VAC2 currently only runs on servers in the beta group, but will be active for all servers very soon.</ul><br><br></p>
