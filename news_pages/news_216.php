...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=216" style="text-decoration: none; color: #BFBA50;">Windows and Linux Dedicated Server Update Released</a></h3>
<span style="font-size: 9px;">November 20, 2003, 5:11 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
There is a new update for both Windows and Linux dedicated server administrators available now. This update does not affect you if you do not run a dedicated server.<br><br>This update will address the recent exploit that would allow an arbitrary file to be downloaded from a game server.<br></p>
