...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=8" style="text-decoration: none; color: #BFBA50;">Neck deep in 4.0 and Brits</a></h3>
<span style="font-size: 9px;">October 3, 2002, 12:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Just dropping a line to let everyone know we're cranking on 4.0 which, among other things, will mark the introduction of troops from Great Britain. We'll have more info on all the new features and additions to DoD as we near 4.0's completion.<br></p>
