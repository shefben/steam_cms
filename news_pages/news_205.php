...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=205" style="text-decoration: none; color: #BFBA50;">Update Recalled</a></h3>
<span style="font-size: 9px;">October 21, 2003, 4:05 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
We have identified a bug in the recent update which was causing Steam users to download much more content than was necessary. This was overloading the network and not allowing people to play games, so we have reverted back to the previous version for now. There will probably be some network congestion due to all this for the next couple of hours or so.<br></p>
