...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=337" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source Update</a></h3>
<span style="font-size: 9px;">November 3, 2004, 7:41 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Counter-Strike: Source update is available and will be applied automatically when Steam is restarted. The changes include:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" <br><li>Added cheat protection to flashlight option<br><li>Changed mp_roundtime to accept more granular values<br><li>Fixed display of Asian Windows 98 fonts<br><li>Fixed memory leak after multiple level changes<br></ul><br></p>
