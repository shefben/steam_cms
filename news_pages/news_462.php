...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=462" style="text-decoration: none; color: #BFBA50;">Steam Client Update Released</a></h3>
<span style="font-size: 9px;">October 11, 2005, 6:02 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A new Steam client has been released, updating the integrated Steam store and the Games list. The update will be applied automatically when your Steam client is restarted.<br> <br>These changes are part of a larger set of features (collectively known as Steam 3) which will be introduced over the course of the coming months. Today's release allows Steam to offer a larger and more varied collection of games to our customers, and introduces a-la-carte purchases.<br><br>We hope everyone enjoys the changes. <br><br>And Don't forget to pre-order Rag Doll Kung Fu while it's still only $12.95!<br><br></p>
