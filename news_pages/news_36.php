...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=36" style="text-decoration: none; color: #BFBA50;">COUNTER-STRIKE: CONDITION ZERO V1.2 COMING NEXT WEEK</a></h3>
<span style="font-size: 9px;">May 27, 2004, 2:46 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Version 1.2 of CS:CZ will be released next week via Steam. The update includes high-definition hostage models with all-new AI, 2 new player models, brand new maps, and other enhancements. <br> <br>The improved hostages will show emotions such as fear, attempt to escape on their own if ignored, and even talk to the player to give clues about what they've seen. The new player models feature the Russian SPETSNAZ counter-terrorist and Militia terrorist.<br></p>
