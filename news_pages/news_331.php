...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=331" style="text-decoration: none; color: #BFBA50;">Counter-Strike: Source Update</a></h3>
<span style="font-size: 9px;">October 22, 2004, 5:05 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to Counter-Strike: Source has just been released. Steam will update itself automatically when you restart. Here is a list of the changes:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>COUNTER-STRIKE: SOURCE CHANGES / ADDITIONS:</b><br><li>Fixed various name changing exploit crashes</ul><br></p>
