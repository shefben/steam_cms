...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=191" style="text-decoration: none; color: #BFBA50;">It's Alive!</a></h3>
<span style="font-size: 9px;">September 18, 2003, 4:07 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
As <em>many</em> of you have noticed, Steam is back up now. Launching Steam and getting into a game should work just fine. Friends does currently work while playing a game, but not from the desktop. The Friends servers require some networking changes before they're fully functional again. We're working on this now.<br><br>As always, get in touch if you have any questions.<br></p>
