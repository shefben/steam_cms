...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=192" style="text-decoration: none; color: #BFBA50;">Steam Update Coming at Approximately 6:30 PDT</a></h3>
<span style="font-size: 9px;">September 19, 2003, 6:08 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
We are about to release a Steam update. When it is released to our servers you'll need to restart Steam in order to continue using the system. (About ten minutes beforehand, we will send out a message through Friends alerting everyone.)<br><br>Here is a list of what's included in this update:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Reduced the need for clients with fully populated caches to connect to a content server</li><br><li>Reworked some of the retry logic for content server tickets on the Steam backend</li><br><li>Fixed wierdness with next/prev buttons in conversion wizard</li><br><li>Fixed failed login potentially opening two error dialogs</li><br><li>Added conversion wizard for any a cache for a game is created, if there is an existing installation to convert from</li><br><li>Fixed bad error messages for connection issues when logging in</li><br><li>Enabled cancel button on conversion wizard</li><br><li>Optimized Friends searching with wildcards</li><br><li>Fixed "NumRegisteredChildern" assert</li><br></ul><br></p>
