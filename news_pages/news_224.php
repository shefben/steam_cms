...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=224" style="text-decoration: none; color: #BFBA50;">Steam Update Released</a></h3>
<span style="font-size: 9px;">December 19, 2003, 3:33 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to Steam has been released to fix a problem that a small number of users have experienced when attempting to launch. Users who experienced this bug would see the initial progress bar reach 99% and not progress any further.<br><br>Users who are currently in this state should download and run <a href="/download/SteamInstall.exe">this installer</a> in their current Steam directory.<br></p>
