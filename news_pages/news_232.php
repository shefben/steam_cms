...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=232" style="text-decoration: none; color: #BFBA50;">Dedicated Server Update</a></h3>
<span style="font-size: 9px;">January 22, 2004, 5:57 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A small update for all dedicated servers will be released tomorrow afternoon.  This update will address performance-related issues and does not include any new features.  Watch this space for details.<br></p>
