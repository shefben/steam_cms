...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=474" style="text-decoration: none; color: #BFBA50;">Half-Life 2: Lost Coast Update Released</a></h3>
<span style="font-size: 9px;">November 2, 2005, 4:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to Half-Life 2: Lost Coast and the Source Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Half-Life 2: Lost Coast</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed a problem with commentary and the save/restore problem. A symptom of this problem would be combine soldiers standing with their arms outstretched</ul><br><b>Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed a rare crash in the physics system<br><li>Fixed command line error when trying to run maps that contain the characters '-' or '+'</ul> <br><br></p>
