...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=346" style="text-decoration: none; color: #BFBA50;">Authentication Delays</a></h3>
<span style="font-size: 9px;">November 16, 2004, 4:35 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
We've received a number of reports from people experiencing delays with Half-Life 2 authentication. We are investigating the issue and will update everyone as soon as possible. We appreciate your patience and hope to have everyone in the game very soon.<br></p>
