...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=364" style="text-decoration: none; color: #BFBA50;">Half-Life 2: Deathmatch and SDK Update</a></h3>
<span style="font-size: 9px;">November 30, 2004, 8:05 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Greg Coomer</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Half-Life 2 update has been released via Steam. Please restart Steam to apply the update.<br><br>Included in this update:<br><br>Half-Life 2: Deathmatch<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>New multiplayer game featuring physics simulation system</li></ul><br>Half-Life 2/Source SDK<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Includes game code needed to create Half-Life 2/Source MODs</li><br><li>Ability to edit Half-Life 2 maps</li><br><li>Maya model exporter</li><br><li>3d Studio Max model exporter source code</li><br><li>Sample MOD with vehicles</li><br></ul><br>Source Updates<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>HTTP and non-HTTP map auto downloading functionality</li><br><li>Enhanced dedicated server logging capabilities</li><br><li>Various tweaks and fixes</li><br></ul><br>*Also: A Half-Life 2: Deathmatch <a href="/?area=map_contest">Map Making Contest</a> has been announced. The winning entry will receive a cash prize of $5,000. Two runner up entries will receive a cash prize of $3,000.<br></p>
