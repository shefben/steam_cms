...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=32" style="text-decoration: none; color: #BFBA50;">JESS CLIFFE ON IGN</a></h3>
<span style="font-size: 9px;">May 22, 2004, 10:01 am &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
IGN recently hit up Valve's Jess Cliffe, co-creator of CS, to discuss the multiple single player modes and other features included in <em>Counter-Strike: Condition Zero</em>. <a href="http://pc.ign.com/articles/441/441228p1.html?fromint=1" target="_blank">Click here</a> to read the entire interview.<br></p>
