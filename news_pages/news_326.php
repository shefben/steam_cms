...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=326" style="text-decoration: none; color: #BFBA50;">Steam Client Update Released</a></h3>
<span style="font-size: 9px;">October 6, 2004, 4:37 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to the Steam client has just been released. Steam will update itself automatically when you restart. Here is a list of the changes:<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>STEAM CLIENT CHANGES:</b><br><li>Preparations for Half-Life 2 Steam offers<br></ul><br></p>
