...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=290" style="text-decoration: none; color: #BFBA50;">Valve Releases Cyber Cafe Server</a></h3>
<span style="font-size: 9px;">August 13, 2004, 2:48 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
The Valve Cyber Caf&eacute; License Server is now available to subscribers of the Valve Cyber Caf&eacute; Program. Among other features, the Cyber Caf&eacute; License Server allows caf&eacute;s to manage their licenses on a concurrent user basis, locally update individual computers on a caf&eacute;'s local area network (reducing bandwidth needs for updates), and allow individual users with personal Steam accounts to access their account on any computer station located at a cyber caf&eacute; site.<br></p>
