...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=202" style="text-decoration: none; color: #BFBA50;">Counter-Strike and Team Fortress Classic Updates Released</a></h3>
<span style="font-size: 9px;">October 10, 2003, 3:01 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates for Counter-Strike and Team Fortress Classic have just been released through Steam. These are server updates, so once admins have restarted their servers the update will take effect. Here is what's included:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>Team Fortress Classic</b><br><li>fixed teleporter crash</li><br><li>fixed spectator crash</li><br><br><b>Counter-Strike</b><br><li>fixed shield not resetting player max speed when dropped</li><br><li>fixed being able to throw shield through walls if close enough</li><br><li>fixed dropping shield while reloading pistol causing the reload to happen faster</li><br><li>fixed case where shield could become invisible to other users</li><br><li>fixed typos in de_aztec and de_airstrip map descriptions</li><br></ul><br></p>
