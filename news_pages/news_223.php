...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=223" style="text-decoration: none; color: #BFBA50;">Steam Startup Fix Released</a></h3>
<span style="font-size: 9px;">December 18, 2003, 1:21 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
After yesterday's release, Steam was crashing for some users on startup. A fix for this problem has just been released. When you restart Steam, you'll automatically download the fixed version. As always, let us know if you run into problems.<br></p>
