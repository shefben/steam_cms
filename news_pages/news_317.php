...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=317" style="text-decoration: none; color: #BFBA50;">Steam Client Update Released</a></h3>
<span style="font-size: 9px;">September 21, 2004, 5:41 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update to the Steam client has just been released. Steam will update itself automatically when you restart. Here is a list of the changes:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>STEAM CLIENT CHANGES / ADDITIONS:</b><br><li>Removed Exit & Logout command<br><li>Improved authentication system<br><li>Improved UI feedback when Internet connection has been lost<br><li>Improved pre-loading behavior (will no longer pause)<br><li>Added new in-game languages: Japanese, Thai, & Russian</ul><br>This update includes a "Half-Life 2 Hardware Survey". This mostly automated survey collects information about Steam users' computer hardware (and some software). We plan to use this information to tune the performance of our games.<br></p>
