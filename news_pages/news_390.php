...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=390" style="text-decoration: none; color: #BFBA50;">Source SDK Update Released</a></h3>
<span style="font-size: 9px;">January 19, 2005, 5:03 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">cliffe</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Source SDK update is available and will be applied automatically when Steam is restarted. The changes include:<br><br><b>Source SDK</b><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added XSI addon for importing and exporting SMDs</li><br><li>Added simple SDK bot sample code for adding bots to your mod</li><br><li>Added source files for six Half-Life 2 single player maps</li><br><li>Added interface plugin to add bots to mods</li><br><li>Fixed resource leak in the SDK launcher and vconfig utiity</li><br><li>Added bspzip tool -- allows you to compile custom content directly into a .bsp</li></ul><br></p>
