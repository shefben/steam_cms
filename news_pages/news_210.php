...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=210" style="text-decoration: none; color: #BFBA50;">Scheduled Downtime</a></h3>
<span style="font-size: 9px;">November 11, 2003, 6:07 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Steam will be down for maintenance tomorrow (Wednesday) beginning at 4:30 am PST. The downtime should last about two hours. During this time, it will not be possible to use Steam -- we'll have things up and running again ASAP.<br></p>
