...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=242" style="text-decoration: none; color: #BFBA50;">Steam Status</a></h3>
<span style="font-size: 9px;">March 3, 2004, 8:09 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Since this morning's update was released, the Steam network has been overloaded, causing many Steam users to be unable to login.<br><br>Until the Steam content servers are able to catch up with demand, some users will continue to experience slowness or unresponsiveness from the Steam client. We've been making some changes to the content servers today to accelerate this recovery, and we expect conditions to improve quite a bit by tomorrow morning.<br><br>Thanks, again, for your patience after this update.<br></p>
