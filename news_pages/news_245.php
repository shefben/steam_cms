...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=245" style="text-decoration: none; color: #BFBA50;">Steam Update Release</a></h3>
<span style="font-size: 9px;">March 9, 2004, 6:28 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
There has been a Steam update tonight to address a few problems from last week's release.<br><br>This update is for all of the games currently on Steam. The specific changes are:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Changed HTTP download behavior to retry connections using old trickle download method if it can't download all files.</li><br><li>Fixed a crash bug when connecting to a dedicated server with an empty mapcycle.</li><br><li>Fixed a bug where MP3 volume wasn't working properly.</li><br><li>Fixed "STEAM UserID 0:0:1 is already in use on this server" message when connecting to LAN servers in offline mode.</li><br><li>Fixed memory leak in HLTV.</li></ul><br>Server admins will want to restart their server to get updated.<br></p>
