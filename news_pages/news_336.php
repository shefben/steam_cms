...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=336" style="text-decoration: none; color: #BFBA50;">Steam Client Update Released</a></h3>
<span style="font-size: 9px;">November 2, 2004, 4:25 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A platform update is available and will be applied automatically when Steam is restarted. The changes include:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><b>STEAM CLIENT CHANGES / ADDITIONS:</b><br><li>Added Tools section to Steam UI <br><li>Fixed Japanese, Thai, and Russian characters drawing incorrectly under Windows 98<br><li>Fixed DoD:S showing up in the Steam monitor as downloading<br><li>Fixed HL2 preloading stuck at 89% for some users<br><li>Fixed condition causing "non-zero size of m_uMallocedBlock" message<br></ul><br></p>
