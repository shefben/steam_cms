...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=197" style="text-decoration: none; color: #BFBA50;">Counter-Strike Update Released</a></h3>
<span style="font-size: 9px;">September 25, 2003, 6:13 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
The Counter-Strike update mentioned below has been released. This update is primarily for dedicated servers. The update requires a server restart, and will take effect as soon as the admin runs the stand-alone (HLDS) update tool.<br></p>
