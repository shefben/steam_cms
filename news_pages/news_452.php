...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=452" style="text-decoration: none; color: #BFBA50;">Source Engine and Half-Life 1: Engine Updates Available</a></h3>
<span style="font-size: 9px;">October 3, 2005, 5:11 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Updates to the Source Engine and Half-Life 1: Engine have been released. The updates will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed loading error when trying to debug Source MODs using the SDK<br><li>Fixed a startup crash in Windows 98<br></ul><br><b>Half-Life 1: Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Fixed name exploit causing client crash</ul><br><br></p>
