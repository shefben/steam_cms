...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=408" style="text-decoration: none; color: #BFBA50;">Source SDK Update Released</a></h3>
<span style="font-size: 9px;">April 7, 2005, 3:24 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Source SDK update is available and will be applied automatically when Steam is restarted. The changes include:<br><br><b>Source SDK</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>New hl2mp character model sample<br><li>Fixed some cases of having to run the base game before being able to debug your mod<br><li>Optimized bandwidth usage in mods based upon the hl2mp code base<br><li>Implemented a fix in the lag compensation code that was occasionally preventing players from respawning correctly<br><li>Fixed xwad running vtex incorrectly<br><li>Fixed xwad building into the wrong target directory<br></ul><br><br><br></p>
