...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=30" style="text-decoration: none; color: #BFBA50;">CS-NATION GET THEIR HANDS ON CZ</a></h3>
<span style="font-size: 9px;">May 22, 2004, 9:59 am &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Rizzuh with the latest development version of <em>Condition Zero</em>: <em class="newsquote">"The bots within CS:CZ are some the best AI ever seen in an FPS game. The bots do not seem sub-human and they certainly don't seem super-human either. They feel like humans. They only see what they see. They only hear what they can actually hear."</em> To read the entire article, <a href="http://csnation.counter-strike.net/articles.php/article_170/" target="_blank">click here</a>.<br></p>
