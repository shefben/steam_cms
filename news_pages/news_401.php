...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=401" style="text-decoration: none; color: #BFBA50;">Source SDK Update Released</a></h3>
<span style="font-size: 9px;">March 3, 2005, 5:44 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">cliffe</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A Source SDK update is available and will be applied automatically when Steam is restarted. The changes include:<br><br><b>Source SDK</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added new example character model<br><li>Added new character creation documentation<br><li>Added QC eyes tool<br><li>Added more in-depth shader examples -- including a post-process shader<br><li>Added Motion Mapper - a tool used to map animations across differently-proportioned skeletons<br><li>Fixed dedicated server UI not automatically finding HL2MP MODs<br></ul><br></p>
