...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=343" style="text-decoration: none; color: #BFBA50;">Steam Client Update Released</a></h3>
<span style="font-size: 9px;">November 12, 2004, 3:22 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
A platform update is available and will be applied automatically when Steam is restarted. The changes include:<br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Corrected problem preventing Asian, Russian, Thai, and Japanese Windows ME users from seeing proper text.<br></ul><br></p>
