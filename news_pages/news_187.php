...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=187" style="text-decoration: none; color: #BFBA50;">A Note About WON and Counter-Strike 1.5</a></h3>
<span style="font-size: 9px;">September 17, 2003, 11:35 am &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
There seems to be a lot of confusion over the proposed plan to pull the plug on WON.  WON <em>will be available</em> until the Steam service is working the way it was intended to.  We will not simply pull the plug.  If you wish to, you can reinstall Half-Life (if necessary) and play Counter-Strike 1.5 the way you always have.<br><br>I hope that eases some fears.<br><br>Some of the constructive feedback we've received has been quite valuable, and we're working to create a product that everyone will be happy with.<br></p>
