...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=411" style="text-decoration: none; color: #BFBA50;">Half-Life 2: Deathmatch and Source Engine Updates Available</a></h3>
<span style="font-size: 9px;">April 25, 2005, 5:56 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Alfred Reynolds</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
An update is available for Half-Life 2: Deathmatch and the Source Engine. The update will be applied automatically when your Steam client is restarted. The specific changes include:<br><br><b>Half-Life 2: Deathmatch</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Added new map, dm_runoff</ul><br><b>Source Engine</b><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" ><li>Moved default Steam port to 27009 (UDP) from 27030. Use <i>-steamport &lt;port&gt;</i> to override this setting</ul><br></p>
