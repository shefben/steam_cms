...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=367" style="text-decoration: none; color: #BFBA50;">HL2DM, Source SDK, Source Engine Update Released</a></h3>
<span style="font-size: 9px;">December 2, 2004, 5:41 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Half-Life 2: Deathmatch, Source SDK, and Source Engine updates are available and will be applied automatically when Steam is restarted. The changes include:<br><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" >Half-Life 2: Deathmatch<br><li>Players now play grenade throw animation and RPG fire animation <br><li>Items and weapons punted from their original spawn position now return after x time has passed (sv_hl2mp_weapon_respawn_time, sv_hl2mp_item_respawn_time) <br><li>Improved player crouch animations<br></ul><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" >Source SDK<br><li>Included support for making HL2DM maps<br><li>Included sample source HL2DM map: dm_lockdown.vmf <br><li>Added xwad, vtf2tga, and glview tools <br><li>Fixed problems running vrad on certain machines <br><li>Fixed bugs adding game configurations with long paths <br><li>Improved detection of bad game paths</ul><br><ul style="padding-bottom: 0px; margin-bottom: 0px;" >Source Engine<br><li>Fixed server plugins not loading under Steam <br><li>Fixed rcon kick failing <br><li>Fixed UDP logging functions not working properly with quoted strings</ul><br></p>
