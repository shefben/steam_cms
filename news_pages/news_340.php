...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=340" style="text-decoration: none; color: #BFBA50;">Source SDK Tools Available Now</a></h3>
<span style="font-size: 9px;">November 5, 2004, 1:52 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">valve</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Valve has released the Source Software Development Kit (SDK) Tools via Steam. A precursor to the release of the full SDK, which will be released shortly after Half-Life 2 is made available, the Source SDK Tools release offers a comprehensive toolset for starting production on Source-based MODs, including Hammer, XSI EXP for Half-Life 2, compiling tools, the Source Model Viewer, documentation on programming, modeling, building materials, and more. For more information, please visit <a href="http://www.valve-erc.com/srcsdk/">www.valve-erc.com/srcsdk/</a><br><br></p>
