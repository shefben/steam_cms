...
<!-- end header -->
	...
	<br>
	<div class="narrower">
	<p><h3><a href="index.php?area=news&id=473" style="text-decoration: none; color: #BFBA50;">Unalis Named Valve's Retail Distributor In Taiwan</a></h3>
<span style="font-size: 9px;">October 27, 2005, 10:00 pm &middot; <a href="mailto:contact@valvesoftware.com" style="text-decoration: none;">Chris Bokitch</a><table width="100%" cellpadding="0" cellspacing="0"><tr><td height="1" width="100%" bgcolor="#808080"></td></tr><tr><td height="10" width="100%"></td></tr></table></span>
Valve and Unalis have entered an agreement that grants Unalis the retail distribution rights to a number of Valve's games in Taiwan, including Half-Life® 2: Game of the Year, Counter-Strike™: Source™, as well as the Half-Life® 1 and Counter-Strike™ 1 Anthologies. For more information on Unalis, please visit their <a href="http://www.unalis.com.tw/">website</a>.<br></p>
